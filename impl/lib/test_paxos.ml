...
let%expect_test "Loop" =
  ...
  [%expect
    {|
    t: {log: [{command: Command(Read m1, 1); term : 12},{command: Command(Read m2, 2); term : 12}]; commit_index:0; current_term: 12; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    {|
    t: {log: [{command: Command(Read m1, 1); term : 13},{command: Command(Read m4, 3); term : 13}]; commit_index:-1; current_term: 13; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    {|
    t: {log: [{command: Command(Read m1, 1); term : 12},{command: Command(Read m4, 3); term : 13}]; commit_index:-1; current_term: 13; node_state:Follower(5)}
    actions:
  ...
  [%expect
    {|
    t: {log: [{command: Command(Read m1, 1); term : 13},{command: Command(Read m4, 3); term : 13},{command: Command(Read m5, 4); term : 13},{command: Command(Read m6, 5); term : 13}]; commit_index:1; current_term: 13; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    {|
    t: {log: [{command: Command(Read m1, 1); term : 14},{command: Command(Read m4, 3); term : 14},{command: Command(Read m7, 6); term : 14}]; commit_index:-1; current_term: 14; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    ...
    t1:
    {log:
    [{command: Command(Read m1, 1); term : 13},{command: Command(Read m4, 3); term : 13},{command: Command(Read m5, 4); term : 13},{command: Command(Read m6, 5); term : 13}]; commit_index:1; current_term: 100; node_state:Follower(5)}

    t2:
    {log:
    [{command: Command(Read m1, 1); term : 14},{command: Command(Read m4, 3); term : 14},{command: Command(Read m7, 6); term : 14}]; commit_index:-1; current_term: 100; node_state:Follower(5)} |}] ;
  let rvr0 term =
    RequestVoteResponse
      { term
      ; start_index= 0
