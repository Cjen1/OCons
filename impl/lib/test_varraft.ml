...
open! Utils
open! Actions_f
module Impl = Var_raft.MakeRaft (ImperativeActions)
module Imp = Impl.AT
open! Impl.RaftTypes
open! Impl
...
let make_command_id c id : command = Command.{op= c; id; trace_start = Mtime.of_uint64_ns Int64.zero}
...
let%expect_test "Loop" =
  ...
  [%expect
    {|
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12}]; commit_index:-1; current_term: 12; node_state:Leader{heartbeat:0; rep_ackd:
    ...
    actions: [Send(0, AppendEntries {term: 12; leader_commit: -1; prev_log_index: 2; prev_log_term: 12; entries_length: 1; entries:
                                                             [{command: Command(Read m4, 4); term : 12}]})
  ...
  [%expect
    {|
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12}]; commit_index:3; current_term: 12; node_state:Leader{heartbeat:0; rep_ackd:
  ...
  [%expect
    {|
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(Read m5, 5); term : 12},{command: Command(Read m6, 6); term : 12}]; commit_index:3; current_term: 12; node_state:Leader{heartbeat:0; rep_ackd:
  ...
  [%expect
    ...
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12}]; commit_index:-1; current_term: 13; node_state:Candidate{quorum:{threshold 1, elts:
    []}, timeout:0}}
  ...
  [%expect
    {|
    +Leader for term 13
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(NoOp, -1); term : 13}]; commit_index:-1; current_term: 13; node_state:Leader{heartbeat:0; rep_ackd:
  ...
  [%expect
    {|
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(NoOp, -1); term : 13},{command: Command(Read m7, 7); term : 13}]; commit_index:-1; current_term: 13; node_state:Leader{heartbeat:0; rep_ackd:
  ...
  [%expect
    ...
    t1:
    {log:
    [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(Read m5, 5); term : 12},{command: Command(Read m6, 6); term : 12}]; commit_index:3; current_term: 100; node_state:Follower{timeout:0; voted_for:None}}

    t2:
    {log:
    [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(NoOp, -1); term : 13},{command: Command(Read m7, 7); term : 13}]; commit_index:-1; current_term: 100; node_state:Follower{timeout:0; voted_for:None}} |}] ;
  ...
  [%expect
    {|
    +Candidate for term 101
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(Read m5, 5); term : 12},{command: Command(Read m6, 6); term : 12}]; commit_index:3; current_term: 101; node_state:Candidate{quorum:{threshold 1, elts:
    []}, timeout:0}}
  ...
  [%expect
    {|
    +Leader for term 101
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(Read m5, 5); term : 12},{command: Command(Read m6, 6); term : 12},{command: Command(NoOp, -1); term : 101}]; commit_index:3; current_term: 101; node_state:Leader{heartbeat:0; rep_ackd:
  ...
  [%expect
    {|
    +Candidate for term 101
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(NoOp, -1); term : 13},{command: Command(Read m7, 7); term : 13}]; commit_index:-1; current_term: 101; node_state:Candidate{quorum:{threshold 1, elts:
    []}, timeout:0}}
  ...
  [%expect
    {|
    +Leader for term 101
    t: {log: [{command: Command(NoOp, -1); term : 11},{command: Command(Read m1, 1); term : 11},{command: Command(NoOp, -1); term : 12},{command: Command(Read m4, 4); term : 12},{command: Command(NoOp, -1); term : 13},{command: Command(Read m7, 7); term : 13},{command: Command(NoOp, -1); term : 101}]; commit_index:-1; current_term: 101; node_state:Leader{heartbeat:0; rep_ackd:
