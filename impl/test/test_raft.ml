...
let%expect_test "transit_leader" =
  ...
  [%expect
    ...
    +Candidate for term 1
    +Leader for term 1
    t': {log: [{command: Command((), -1); term : 1}]; commit_index:-1; current_term: 1; node_state:Leader{heartbeat:1; rep_ackd:
...
let%expect_test "request vote from higher" =
  ...
  [%expect
    ...
    +Leader for term 1
    +Follower for term 10
    t': {log: [{command: Command((), -1); term : 1}]; commit_index:-1; current_term: 10; node_state:Follower{timeout:5; voted_for:2}}
    actions:
    [Send(2,RequestVoteResponse {term:10; success:true})] |}]
...
let%expect_test "Loop" =
  ...
  [%expect
    {|
    +Vote from 1 for term 11
    +Leader for term 11
    t: {log: [{command: Command((), -1); term : 11}]; commit_index:-1; current_term: 11; node_state:Leader{heartbeat:1; rep_ackd:
    [{1, -1}, {2, -1}]; rep_sent:[{1, 0}, {2, 0}]}
  ...
  [%expect
    {|
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11}]; commit_index:-1; current_term: 11; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    {|
    t1: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11}]; commit_index:-1; current_term: 11; node_state:Follower{timeout:5; voted_for:0}}
    a1:
  ...
  [%expect
    {|
    t2: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11}]; commit_index:-1; current_term: 11; node_state:Follower{timeout:5; voted_for:0}}
    a2:
    [Send(0,AppendEntriesResponse {term: 11; success: Ok: 1})] |}] ;
  ...
  [%expect
    {|
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (Read m2), 2); term : 11}]; commit_index:1; current_term: 11; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    ...
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11}]; commit_index:-1; current_term: 12; node_state:Candidate{quorum:{threshold 1, elts:
    []}, timeout:5, repeat:0}}
  ...
  [%expect
    ...
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11}]; commit_index:-1; current_term: 12; node_state:Follower{timeout:5; voted_for:1}}
    actions:
  ...
  [%expect
    {|
    +Vote from 2 for term 12
    +Leader for term 12
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12}]; commit_index:-1; current_term: 12; node_state:Leader{heartbeat:1; rep_ackd:
    [{0, -1}, {2, -1}]; rep_sent:[{0, 2}, {2, 2}]}
    actions: [Send(0,AppendEntries {term: 12; leader_commit: -1; prev_log_index: -1; prev_log_term: 0; entries_length: 3; entries:
                                                               [{command: Command(
                                                                (), -1); term : 11},{command: Command(
                                                                (Read m1), 1); term : 11},{command: Command(
                                                                (), -1); term : 12}]})
  ...
  [%expect
    {|
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12}]; commit_index:-1; current_term: 12; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    {|
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12}]; commit_index:-1; current_term: 12; node_state:Follower{timeout:5; voted_for:1}}
    actions:
  ...
  [%expect
    {|
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12}]; commit_index:3; current_term: 12; node_state:Leader{heartbeat:1; rep_ackd:
    [{0, -1}, {2, 3}]; rep_sent:[{0, 3}, {2, 3}]}
    actions: [CommitCommands
                                                            (Command((), -1),
                                                             Command((Read m1), 1),
                                                             Command((), -1),
                                                             Command((Read m4), 3))] |}] ;
  ...
  [%expect
    {|
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
              (Read m5), 4); term : 12},{command: Command((Read m6), 5); term : 12}]; commit_index:3; current_term: 12; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    ...
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12}]; commit_index:-1; current_term: 13; node_state:Candidate{quorum:{threshold 1, elts:
    []}, timeout:5, repeat:0}}
  ...
  [%expect
    ...
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (Read m2), 2); term : 11}]; commit_index:1; current_term: 13; node_state:Follower{timeout:5; voted_for:2}}
    actions:
  ...
  [%expect
    {|
    +Vote from 0 for term 13
    +Leader for term 13
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
              (), -1); term : 13}]; commit_index:-1; current_term: 13; node_state:Leader{heartbeat:1; rep_ackd:
    [{0, -1}, {1, -1}]; rep_sent:[{0, 4}, {1, 4}]}
    actions: [Send(0,AppendEntries {term: 13; leader_commit: -1; prev_log_index: -1; prev_log_term: 0; entries_length: 5; entries:
                                                               [{command: Command(
                                                                (), -1); term : 11},{command: Command(
                                                                (Read m1), 1); term : 11},{command: Command(
                                                                (), -1); term : 12},{command: Command(
                                                                (Read m4), 3); term : 12},{command: Command(
                                                                (), -1); term : 13}]})
  ...
  [%expect
    ...
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
              (), -1); term : 13},{command: Command((Read m7), 6); term : 13}]; commit_index:-1; current_term: 13; node_state:Leader{heartbeat:1; rep_ackd:
  ...
  [%expect
    ...
    +Follower for term 100
    t0:
    {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
               (Read m2), 2); term : 11}]; commit_index:1; current_term: 100; node_state:Follower{timeout:5; voted_for:None}}

    t1:
    {log:
    [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
     (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
     (Read m5), 4); term : 12},{command: Command((Read m6), 5); term : 12}]; commit_index:3; current_term: 100; node_state:Follower{timeout:5; voted_for:None}}

    t2:
    {log:
    [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
     (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
     (), -1); term : 13},{command: Command((Read m7), 6); term : 13}]; commit_index:-1; current_term: 100; node_state:Follower{timeout:5; voted_for:None}} |}] ;
  ...
  [%expect
    ...
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (Read m2), 2); term : 11}]; commit_index:1; current_term: 101; node_state:Candidate{quorum:{threshold 1, elts:
    []}, timeout:5, repeat:0}}
  ...
  [%expect
    {|
    +Vote from 1 for term 101
    +Leader for term 101
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (Read m2), 2); term : 11},{command: Command((), -1); term : 101}]; commit_index:1; current_term: 101; node_state:Leader{heartbeat:1; rep_ackd:
    [{1, -1}, {2, -1}]; rep_sent:[{1, 3}, {2, 3}]}
    actions: [Send(1,AppendEntries {term: 101; leader_commit: 1; prev_log_index: 1; prev_log_term: 11; entries_length: 2; entries:
                                                               [{command: Command(
                                                                (Read m2), 2); term : 11},{command: Command(
                                                                (), -1); term : 101}]})

                                                             Send(2,AppendEntries {term: 101; leader_commit: 1; prev_log_index: 1; prev_log_term: 11; entries_length: 2; entries:
                                                               [{command: Command(
                                                                (Read m2), 2); term : 11},{command: Command(
                                                                (), -1); term : 101}]})] |}] ;
  (* elect 1 *)
  ...
  [%expect
    ...
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
              (Read m5), 4); term : 12},{command: Command((Read m6), 5); term : 12}]; commit_index:3; current_term: 101; node_state:Candidate{quorum:{threshold 1, elts:
    []}, timeout:5, repeat:0}}
  ...
  [%expect
    {|
    +Vote from 2 for term 101
    +Leader for term 101
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
              (Read m5), 4); term : 12},{command: Command((Read m6), 5); term : 12},{command: Command(
              (), -1); term : 101}]; commit_index:3; current_term: 101; node_state:Leader{heartbeat:1; rep_ackd:
    [{0, -1}, {2, -1}]; rep_sent:[{0, 6}, {2, 6}]}
    actions: [Send(0,AppendEntries {term: 101; leader_commit: 3; prev_log_index: 3; prev_log_term: 12; entries_length: 3; entries:
                                                               [{command: Command(
                                                                (Read m5), 4); term : 12},{command: Command(
                                                                (Read m6), 5); term : 12},{command: Command(
                                                                (), -1); term : 101}]})

                                                             Send(2,AppendEntries {term: 101; leader_commit: 3; prev_log_index: 3; prev_log_term: 12; entries_length: 3; entries:
                                                               [{command: Command(
                                                                (Read m5), 4); term : 12},{command: Command(
                                                                (Read m6), 5); term : 12},{command: Command(
                                                                (), -1); term : 101}]})] |}] ;
  ...
  [%expect
    ...
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
              (), -1); term : 13},{command: Command((Read m7), 6); term : 13}]; commit_index:-1; current_term: 101; node_state:Candidate{quorum:{threshold 1, elts:
    []}, timeout:5, repeat:0}}
  ...
  [%expect
    {|
    +Vote from 0 for term 101
    +Leader for term 101
    t: {log: [{command: Command((), -1); term : 11},{command: Command((Read m1), 1); term : 11},{command: Command(
              (), -1); term : 12},{command: Command((Read m4), 3); term : 12},{command: Command(
              (), -1); term : 13},{command: Command((Read m7), 6); term : 13},{command: Command(
              (), -1); term : 101}]; commit_index:-1; current_term: 101; node_state:Leader{heartbeat:1; rep_ackd:
    [{0, -1}, {1, -1}]; rep_sent:[{0, 6}, {1, 6}]}
    actions: [Send(0,AppendEntries {term: 101; leader_commit: -1; prev_log_index: -1; prev_log_term: 0; entries_length: 7; entries:
                                                               [{command: Command(
                                                                (), -1); term : 11},{command: Command(
                                                                (Read m1), 1); term : 11},{command: Command(
                                                                (), -1); term : 12},{command: Command(
                                                                (Read m4), 3); term : 12},{command: Command(
                                                                (), -1); term : 13},{command: Command(
                                                                (Read m7), 6); term : 13},{command: Command(
                                                                (), -1); term : 101}]})

                                                             Send(1,AppendEntries {term: 101; leader_commit: -1; prev_log_index: -1; prev_log_term: 0; entries_length: 7; entries:
                                                               [{command: Command(
                                                                (), -1); term : 11},{command: Command(
                                                                (Read m1), 1); term : 11},{command: Command(
                                                                (), -1); term : 12},{command: Command(
