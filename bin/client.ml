  ...
  Command.basic ~summary:"Nop operation"
    Command.Let_syntax.(
      ...
      fun () ->
        ...
        op_nop c |> result_to_string |> print_endline)
...
let create =
  Command.basic ~summary:"Creation operation"
    Command.Let_syntax.(
      ...
      fun () ->
        let c = new_client endpoints in
        op_create c key value |> result_to_string |> print_endline)
...
let read =
  Command.basic ~summary:"Read operation"
    Command.Let_syntax.(
      ...
      fun () ->
        let c = new_client endpoints in
        op_read c key |> result_to_string |> print_endline)
...
let update =
  Command.basic ~summary:"Update operation"
    Command.Let_syntax.(
      ...
      fun () ->
        let c = new_client endpoints in
        op_update c key value |> result_to_string |> print_endline)
...
let remove =
  Command.basic ~summary:"Remove operation"
    Command.Let_syntax.(
      ...
      fun () ->
        let c = new_client endpoints in
        op_remove c key |> result_to_string |> print_endline)
